        ...
        <div className="mx-5">
          ...
          <div className="flex flex-row-reverse gap-2">
            ...
            <p className="flex-1 text-right">
              הראש – מכיל את החומר התורשתי (דנ"א) של האב, אשר יועבר לביצית בעת ההפריה. הדנ"א נמצא בתוך גרעין דחוס במיוחד, מה שמאפשר לתא הזרע להיות קטן ואווירודינמי לניידות טובה יותר.
            </p>
          </div>
          <div className="flex flex-row-reverse gap-2">
            <span>2.</span>
